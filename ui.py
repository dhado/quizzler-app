...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_labe = Label(text="Score: 0", fg="white", bg=THEME_COLOR)
    ...
    def get_next_qustion(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"You've reached the end of the quiz with a score of "
                                                            f"{self.quiz.score}")
